...
common_degs <- intersect(occams$Gene, tcga$Gene)
write.table(common_degs, file = "occams_tcga_commonDEGS.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
library(openxlsx)
write.xlsx(collated, "occams_tcga_commonDEGS.xlsx", rowNames = FALSE)
...
pdf("occams_tcga_commonDEGS.pdf",w=6,h=6)
