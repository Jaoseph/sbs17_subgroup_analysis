...
mut_complete <- as.data.frame(cbind(mt_tally.icgc_naive$SBS_96, mt_tally.icgc_naive$ID_83))

# 2. Load annotation (ann)
load('ICGC_Naive_IDnormalised_PhenotypeAnnotation_clust.Rdata')
...
# Save prior clusters
save(mut.dists_mean, file = 'ICGC_Naive_clust_mclust_meanCont.Rdata')
...
ggsave(filename = 'Naive_LikelihoodDistributionsMeans.pdf',
