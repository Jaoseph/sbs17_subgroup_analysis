...
load('mt_tally.barretts.Rdata')
mut_complete <- as.data.frame(cbind(mt_tally.barretts$SBS_96, mt_tally.barretts$ID_83))

# 2. Load annotation (ann)
load('Barretts_IDnormalised_PhenotypeAnnotation_clust.Rdata')
...
# Save prior clusters
save(mut.dists_mean, file = 'Barretts_clust_mclust_meanCont.Rdata')
...
ggsave(filename = 'Barretts_LikelihoodDistributionsMeans.pdf',
