##### Contribution of Barretts WGS-associated signatures using deconstructSigs
...
icgc_idCounts <- read.table('Barretts_indelCounts.txt')
...
print("Saving")
save(sigs_complete,
     file = 'Barretts_deconstructSigs_Cutoff0.01_SBSandIDnormalised.Rdata')
